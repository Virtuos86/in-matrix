...
class MatrixHttpApi(object):
    ...
    def public_rooms(self):
        ...
        return self._send("GET", "/publicRooms")
    ...
    def send_typing(self, room_id, user_id):
        """Perform /rooms/$room_id/typing/$user_id

        Args:
            room_id(str): The room ID to send the m.typing event into.
            user_id(str): The user ID  of the typer.
        """
        body = {
            "typing": True,
            "timeout": 0
        }
        return self._send("PUT", "/rooms/" + room_id + "/typing/" + user_id, body)
